        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {isPublished
                  ? "This blog post will no longer be visible to readers. You can publish it again anytime. Are you sure you want to unpublist it?"
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center gap-2">
          <Avatar email={author.email} size="24" className="rounded-md" />
